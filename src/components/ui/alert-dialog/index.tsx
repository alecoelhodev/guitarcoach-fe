...
const alertDialogContentStyle = tva({
  base: 'bg-neutral-100 rounded-xl overflow-hidden border border-neutral-300 p-3 gap-2',
  parentVariants: {
    size: {
      xs: 'w-[60%] max-w-[360px]',
      sm: 'w-[70%] max-w-[420px]',
...
const alertDialogCloseButtonStyle = tva({
  base: 'group/alert-dialog-close-button z-10 rounded-sm p-2 data-[focus-visible=true]:bg-neutral-200 web:cursor-pointer outline-0',
});
...
const alertDialogBackdropStyle = tva({
  base: 'absolute left-0 top-0 right-0 bottom-0 bg-black/60 web:cursor-default',
});
